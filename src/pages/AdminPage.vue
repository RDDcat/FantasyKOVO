        ...
        <div class="w-[960px] flex flex-col"> 
            ...
            <div class="mb-4">
                ...
                <button
                    ...
                    :class="{'bg-blue-500 text-white': selectedPosition === position, 'bg-white text-black': selectedPosition !== position}"
                >
                    {{ position }}
                </button>
                </div>
            ...
            <div class="mb-4">
                ...
                <button
                    ...
                    class="px-4 py-2 border rounded-md"
                    :class="{'bg-blue-500 text-white': selectedMetricId === metric.id, 'bg-white text-black': selectedMetricId !== metric.id}"
                >
                    {{ metric.name }}
                </button>
                </div>
            </div>
            <input v-model.number="metricScore" type="number" placeholder="지표 점수" class="mt-4">            
